...
Invitados</pre>
    ...
    <section class="riego">
        ...
        <table class="table">
            ...
            <tr>
                <td><pre>Temperatura</pre></td>
                <td><?php	

      // Se crea una consulta de selección.
     
    $consulta="SELECT temperatura FROM datos order by fecha desc limit 1";
...
foreach ($db->query($consulta) as $fila)
{
    ...
    ?></td>
            ...
            <tr>
                <td><pre>Consumo de Riego</pre></td>
                <td></td>
            </tr>
            <tr>
                <td><pre>Humedad en tierra</pre></td>
                <td>
                	<?php	

      // Se crea una consulta de selección.
     
    $consulta2="SELECT humedad FROM datos order by fecha desc limit 1";
